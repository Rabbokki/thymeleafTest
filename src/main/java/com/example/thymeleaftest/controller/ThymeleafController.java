...
//        UserData userData = new UserData("홍길동", 10);
    ...
    public String details(
            ...
            Model model){
       model.addAttribute("selectUser",UserData.fromParams(name,age,addr));
        return "/basic/detail";
    }
    ...
    private void addUser(Model model) {
        List<UserData> userList = new ArrayList<>(
                Arrays.asList(
                        new UserData("장원영",11,"Seoul"),
                        new UserData("안유진",221,"대구"),
                        new UserData("이서",215,"부산"),
                        new UserData("가을",214,"인천"),
                        new UserData("겨울",232,"세종"),
                        new UserData("봄",24,"독도"),
                        new UserData("길동",34,"독도")
                        )
        );
